        ...
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-xl lg:max-w-lg">
            ...
            >
              <LocalizedClientLink
                href="/store"
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#5B8C3E] text-white rounded-full
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/80 backdrop-blur-sm text-gray-800 rounded-full
                font-medium text-sm uppercase tracking-wider border border-gray-200
            ...
            {/* Trust Indicators */}
            <div
              className={`flex flex-wrap items-center gap-6 mt-10 pt-8 border-t border-gray-200/50 transition-all duration-700 delay-500 ${
                isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            >
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-[#5B8C3E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">Entrega en 24-72h</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-[#5B8C3E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
